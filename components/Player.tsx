        ...
        TrackPlayer.addEventListener(
            ...
            (event: PlaybackActiveTrackChangedEvent) => {
                ...
                webview.current?.injectJavaScript(
                    `window.changeSong("${event.track?.id}")`
                );
            }
        );
    }, [webview]);
                    ...
                    <Animated.View style={{ transform: [{ rotate: "0deg" }] }}>
                        <Image
                            source={{
                                uri:
                                    song?.track?.artwork ||
                                    process.env.EXPO_PUBLIC_SONG_DEFAULT_IMAGE,
                            }}
                ...
                <View style={styles.metaButtonsView}>
                    <TouchableOpacity
                        ...
                        onPress={async () => {
                            ...
                            if (loop === RepeatMode.Off)
                                await TrackPlayer.setRepeatMode(
                                    RepeatMode.Queue
                                );
                            else if (loop === RepeatMode.Queue)
                                await TrackPlayer.setRepeatMode(
                                    RepeatMode.Track
                                );
                            else if (loop === RepeatMode.Track)
                ...
                <TouchableOpacity
                    ...
                    {playing === false ? (
                        <Svg
                            ...
                            fill="white">
                            <Path
                                d="M13.5 7.13397C14.1667 7.51887 14.1667 8.48113 13.5 8.86603L1.5 15.7942C0.833334 16.1791 2.11047e-07 15.698 2.01867e-07 14.9282L3.66308e-08 1.0718C2.7451e-08 0.301997 0.833333 -0.179129 1.5 0.205771L13.5 7.13397Z"
                                fill={"white"}
                            />
                        </Svg>
                    ) : (
                        <Svg
                            ...
                            fill="white">
                            <Path
                                d="M3.69409 0.829285H1.47339C0.98281 0.829285 0.585114 1.22698 0.585114 1.71756V11.4886C0.585114 11.9792 0.98281 12.3769 1.47339 12.3769H3.69409C4.18467 12.3769 4.58237 11.9792 4.58237 11.4886V1.71756C4.58237 1.22698 4.18467 0.829285 3.69409 0.829285Z"
                                fill="white"
                            />
                            <Path
                                d="M10.2822 0.829346H8.06147C7.57088 0.829346 7.17319 1.22704 7.17319 1.71763V11.4887C7.17319 11.9793 7.57088 12.377 8.06147 12.377H10.2822C10.7727 12.377 11.1704 11.9793 11.1704 11.4887V1.71763C11.1704 1.22704 10.7727 0.829346 10.2822 0.829346Z"
                                fill="white"
                            />
                        </Svg>
                    )}
            ...
            <View>
                ...
                <View style={styles.time}>
                    <Text style={styles.timeText}>
                        {(songProgress.position / 60).toFixed(0) +
                            ":" +
                            (songProgress.position % 60)
                                .toFixed(0)
                                .padStart(2, "0")}
                    </Text>
                    <Text style={styles.timeText}>
                        {" "}
                        {(songProgress.duration / 60).toFixed(0) +
                            ":" +
                            (songProgress.duration % 60)
                                .toFixed(0)
                                .padStart(2, "0")}{" "}
                    </Text>
                </View>
